...
class TWOFG():
    ...
    def move(self, t_index=0, t_width=20.0, f_wait=True):
        '''
...
if __name__ == '__main__':
    ...
    print(f"{gripper_2FG7.isConnected()=}")
    print(f"{gripper_2FG7.isBusy()=}")
    print(f"{gripper_2FG7.isGripped()=}")
    print(f"{gripper_2FG7.getStatus()=}")
    print(f"{gripper_2FG7.get_ext_width()=}")
    print(f"{gripper_2FG7.get_min_ext_width()=}")
    print(f"{gripper_2FG7.get_max_ext_width()=}")
    print(f"{gripper_2FG7.move(t_width=73, f_wait=True)=}")
    time.sleep(3)
    print(f"{gripper_2FG7.get_force()=}")
    print(f"{gripper_2FG7.grip(t_width=40, n_force=20, p_speed=10, f_wait=True)=}")
    print(f"{gripper_2FG7.get_force()=}")
